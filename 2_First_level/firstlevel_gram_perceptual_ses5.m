...
% Adapted by Marjolein Mues for ELP Morphology Project ses-5 on 07/17/2025

function firstlevel_gram_ses5 (subjects)
%parpool;
addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab/Marjolein/typical_data_analysis/3firstlevel')); % the path of your scripts
...
analysis_folder='ses5_analysis_gram_perceptual'; % the name of your first level modeling folder

% define your data path
data=struct();
root='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5' ;  %your project path
...
%matched.
contrasts={'GeneralSentence_Cont'};
GeneralSentence_Cont=[-2 1 1 0];


%adjust the contrast by adding six 0s into the end of each session
rp_w=zeros(1,6);
% empty=zeros(1,10);
weights={[GeneralSentence_Cont rp_w GeneralSentence_Cont rp_w]};
