...
% Adapted by Marjolein Mues for ELP Morphology Project ses-5 on 11/06/2024

function firstlevel_phon_ses5 (subjects)
parpool;
...
analysis_folder='ses5_analysis_phon'; % the name of your first level modeling folder different for ses-7 and ses-9
