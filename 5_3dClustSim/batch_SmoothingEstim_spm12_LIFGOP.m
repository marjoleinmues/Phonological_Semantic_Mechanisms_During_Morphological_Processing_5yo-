...
%List your subjects 
namesubjects={'sub-5006', 'sub-5008', 'sub-5009', 'sub-5013', 'sub-5015', 'sub-5017', 'sub-5029', 'sub-5034', 'sub-5036', 'sub-5051', 'sub-5054', 'sub-5055', 'sub-5061', 'sub-5065', 'sub-5069', 'sub-5070', 'sub-5071', 'sub-5075', 'sub-5095', 'sub-5099', 'sub-5102', 'sub-5109', 'sub-5117', 'sub-5125', 'sub-5139', 'sub-5140', 'sub-5141', 'sub-5148', 'sub-5159', 'sub-5167', 'sub-5169', 'sub-5199', 'sub-5215', 'sub-5259', 'sub-5270', 'sub-5286', 'sub-5304', 'sub-5328', 'sub-5336', 'sub-5338', 'sub-5352'};

%3dcluststim options
threedclust=1; %Run 3dclustsim with results? 1 for yes, 0 for no
pthr = [.005]; %enter values for pthr .05 .01
ROI = '/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/ROIs/phon_top500/secondlevel_phon/IFGop_elision_scaled_score_p1_k500_roi.nii'; %pathway to your ROI
